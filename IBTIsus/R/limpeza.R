...
### Tabelas do CNES ###
  ...
  if(grepl('CNES', diretorio, fixed = T)){
    if(grepl('EE', diretorio, fixed = T)){
      ...
      dados<-subset(dados, select = -c(MICR_REG, DISTRADM, ESFERA_A, RETENCAO, NATUREZA, NIV_HIER,
                                      TERCEIRO, CODUFMUN, TPGESTAO, PF_PJ, TP_UNID, TURNO_AT, VINC_SUS,
                                      TP_PREST, SGRUPHAB))                                    
    }
    ...
    if(grepl('EP', diretorio, fixed = T)){
      ...
      dados<-subset(dados, select = -c(REGSAUDE, MICR_REG, DISTRADM, ESFERA_A, RETENCAO, NATUREZA, 
                                      NIV_HIER, PRONASCI, TERCEIRO, CODUFMUN, TPGESTAO, TP_PREST, 
                                      AP01CV03, AP01CV04, AP02CV03, AP02CV04, AP03CV03, AP03CV04, 
                                      AP04CV03, AP04CV04, AP05CV02, AP05CV03, AP05CV04, AP05CV05, 
                                      AP05CV06, AP06CV02, AP06CV03, AP06CV04, AP06CV05, AP06CV06, 
                                      AP07CV02, AP07CV03, AP07CV04, AP07CV05, AP07CV06, ATEND_PR, 
                                      GESPRG3M, GESPRG4M, GESPRG6M, PF_PJ, EQBRMEDI, CNPJ_MAN, 
                                      NIV_DEP, VINC_SUS, GESPRG1M, GESPRG2M, GESPRG5M, AP01CV02, 
                                      AP01CV05, AP01CV06, AP02CV01, AP02CV02, AP02CV05, AP02CV06, 
                                      AP03CV02, AP03CV05, AP03CV06, AP04CV02, AP04CV06,
    ...
    if(grepl('ST', diretorio, fixed = T)){
     names(dados)[1] <- 'FK_COD_CNES'
      ...
      dados<-subset(dados, select = -c(DISTRSAN,COD_IR,REGSAUDE, MICR_REG,DISTRADM,ESFERA_A,RETENCAO,NATUREZA,NIV_HIER,
                                      ...
                                      AP04CV03,AP04CV04,AP05CV03,AP05CV04,AP06CV03,AP06CV04,AP06CV05,AP06CV06,
